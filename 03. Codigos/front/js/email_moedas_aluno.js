...
document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", function () {
    ...
    if (!nomeAluno || !nomeProfessor || !emailProfessor || !qtdMoedas || !emailAluno) {
    ...
    const TEMPLATE_PROFESSOR = "template_4747wpq"; 
    ...
    .then(() => console.log("Email enviado para o aluno com sucesso!"))
    .catch((error) => console.error("Erro ao enviar email para o aluno:", error));
    ...
    .then(() => console.log("Email de confirmação enviado ao professor!"))
    .catch((error) => console.error("Erro ao enviar email para o professor:", error));
